...
def load_cnn(dataset_name, sup_source, num_keywords=10, with_evaluation=True, truncate_len=None,
    ...
    if sup_source == 'labels' or sup_source == 'keywords':
        keywords = load_keywords(data_path, sup_source, args.kw_file)
        return x, data, y, word_counts, vocabulary, vocabulary_inv, len_avg, len_std, keywords, perm
        ...
        return x, data, y, word_counts, vocabulary, vocabulary_inv, len_avg, len_std, keywords, sup_idx, perm
